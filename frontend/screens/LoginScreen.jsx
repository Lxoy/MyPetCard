  ...
  export default function LoginScreen({ navigation }) {
    ...
    const handleLogin = async () => {
      ...
      if (!password) {
        ...
        setErrorPassword("Your password must be 8 characters long.");
        valid = false;
      } else if (!atLeastOneUppercaseCharacter(password)) {
        setErrorPassword("Your password does not contain one uppercase character.");
        valid = false;
      } else if (!atLeastOneLowercaseCharacter(password)) {
        setErrorPassword("Your password does not contain at least one lowercase character.");
        valid = false;
      } else if (!atLeastOneNumber(password)) {
        setErrorPassword("Your password does not contain at least one number.");
        valid = false;
      } else if (!atLeastOneSpecialCharacter(password)) {
        setErrorPassword("Your password does not contain at least one special character.");
        valid = false;
      }
