        ...
        <ImageBackground className='flex-1' source={require('../img/background.png')} resizeMode='fill'>
            ...
            <View className='flex-1 justify-end mb-14'>
                ...
                <View className='items-center'>
                    <TouchableOpacity className='bg-primary items-center justify-center rounded-3xl w-96 h-14' onPress={() => navigation.navigate("LoginScreen")}>
                        <Text className='text-accent font-poppins_bold text-xl'>Log In</Text>
                    </TouchableOpacity>
                    <TouchableOpacity className='m-3 border-2 items-center justify-center rounded-3xl w-96 h-14' onPress={() => navigation.navigate("SignupScreen")}>
                        <Text className='text-primary font-poppins_bold text-xl'>Sign Up</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ImageBackground>
