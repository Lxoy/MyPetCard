        ...
        <ImageBackground className='flex-1' source={require('../img/background.png')} resizeMode='fill'>
            ...
            <View className='flex-1 justify-end mb-14'>
                ...
                <View className='items-center mb-5'>
                    <TouchableOpacity className='bg-primary items-center justify-center rounded-full w-80 h-12'>
                        <Text className='text-accent font-bold text-lg'>Log In</Text>
                    </TouchableOpacity>
                    <TouchableOpacity className='m-5 border-2 items-center justify-center rounded-full w-80 h-12'>
